...
void logos() {
    ...
    centerFont(&font, screen, screen->w / 2, screen->h / 2 - font.h / 2, "in association with");
    updateDisplay();
    delay(2000);

    edlogo();

    centerFont(&font, screen, screen->w / 2, screen->h / 2 - font.h / 2, "present");
    updateDisplay();
    delay(1250);
...
void intro() {
    ...
    centerFont(&font, screen, screen->w / 2, screen->h / 2 - font.h / 2, GAMENAME);
...
void outro() {
    ...
    centerFont(&font, screen, screen->w / 2, screen->h / 2 - font.h * 2, GAMENAME);
    centerFont(&font, screen, screen->w / 2, screen->h / 2 + font.h, "(c) 2005, Sweater Puppy Games");
    centerFont(&font, screen, screen->w / 2, screen->h / 2 + font.h * 2, "Thanks for playing!");
