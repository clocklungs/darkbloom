...
const char *VAR_GetError() { return var_error.c_str(); }

void VAR_SetError(const char *error) { var_error = error; }
...
VAR_paramList constructor
  initializes the structure as empty
*********************************************************************/
VAR_paramList::VAR_paramList() { head = NULL; }
...
*********************************************************************/
VAR_param *VAR_paramList::set(const char *param, const char *datatype, const void *value) {
    /*local variables*/
...
char *VAR_paramList::toString(const char *param, char *buffer, int num) {
    ...
    if (search != NULL) {
        ...
        /*in list?, then returns its evaluated value*/
        if (search->key == param)
            return search->toString(buffer, num);
    }
    /*not in list, so it is false*/
    return NULL;
}
